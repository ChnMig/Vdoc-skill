...
For local packaging, run `npm run release:package -- v0.2.1` with the version in the manifests. Output stays in the ignored `.artifacts/release/` directory. The workflow uploads the installable package to GitHub Releases; npm registry publication remains separate.
