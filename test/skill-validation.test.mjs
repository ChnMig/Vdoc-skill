...
const v01ToolSchemas = new Map([
  ...
  ["update_api_version_draft", { required: ["project_id", "document_id", "draft_id", "branch_id", "version_name", "schema_content"], optional: ["changelog", "source_git_commit_id"] }],
  ...
  ["update_doc_draft", { required: ["project_id", "document_id", "draft_id", "branch_id", "version_name", "markdown_content"], optional: ["changelog", "source_git_commit_id"] }],
